$.fn.datepicker.dates['tr'] = {
		...
		format: "dd.mm.yyyy"
				...
				$(function(){
						 ...
						 $('#datePickerver').datepicker({
				        	autoclose: true,
				            format: 'yyyy-mm-dd',
				            language:'tr',
							});
			
 					$('#datePickerdog').datepicker({
				        	autoclose: true,
				            format: 'yyyy-mm-dd',
				            language:'tr',
							});
...
$(function(){
  ...
  $("#sirket_tel").mask("(0999) 999 99 99");
  $("#sirket_faks").mask("(0999) 999 99 99");
  $("#sirket_tel_gun").mask("(0999) 999 99 99");
  $("#faks_tel_gun").mask("(0999) 999 99 99");
  $("#login-tel").mask("(0999) 999 99 99");
  $("#login-tel2").mask("(0999) 999 99 99");
