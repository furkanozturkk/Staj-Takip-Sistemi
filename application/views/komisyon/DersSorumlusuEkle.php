<header class="page-header">
	<div class="container-fluid">
		<h2 class="no-margin-bottom">Ders Sorumlusu Oluştur</h2>
	</div>
</header>
				...
				<div class="row">
					<div class="col-lg-12 bg-white">
						<div class="form d-flex align-items-center">
							<div class="content">
								<form method="post" action="<?=base_url();?>Komisyon/derssorumlusu_olustur" id="kform" novalidate="novalidate" style="max-width:100%;">
									<div class="row">
										
										<div class="col-sm-6" style="padding:10px;">
											<div class="form-group">
												<input id="login-ogrno" type="text" name="derssorumlusu_adi" data-validation="required" class="input-material">
												<label for="login-ogrno" class="label-material">Ders Sorumlusu Adı</label>
											</div>
											<div class="form-group">
										...
										<div class="col-sm-12"style="padding:10px;">
											<input type="submit" name="btn_kayit" class="btn btn-primary" value="Ders Sorumlusu Oluştur" />	
										</div>
									</div>
								</form>
								  <?php
