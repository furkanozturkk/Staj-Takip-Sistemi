      	...
      	<div class="card-body">
         	<form class="form-horizontal" method="post" id="basvuru" action="<?=base_url();?>stajbasvuru/basvuru_yap">
            	...
            	<div class="form-group row">
               		...
               		<div class="col-sm-2">
                  		<button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-info" style="float: right;">Şirket Ekle</button>
               		</div>
            	</div>
            	<div class="form-group row">
	                              		...
	                              		<div class="col-sm-6">
	         								...
	         								<form action="<?= base_url();?>Stajbasvuru/ogrenci_sirket_ekle/" method="post" class="form-horizontal" enctype="multipart/form-data">
										        ...
										        <div class="form-group row">
										         	...
										         	<div class="col-sm-8">
										         		<input type="email" class="form-control" name="sirket_mail" data-validation="required emaill" id="sirket_mail">
										         	</div>
										        </div>
										        <div class="line"></div>
										        	<div class="form-group row">
									    ...
									    <div class="col-sm-6">
									        ...
									        <hr>
									         	...
									         	<div class="form-group row">
									         		...
									         		<div class="col-sm-8">
									         			<input type="text" class="form-control" name="yetkili_ad" required="required" id="yetkili_ad">
									         		</div>
									         	</div>
									         	<div class="line"></div>
									         	<div class="form-group row">
										        ...
										        <div class="form-group row">
										         	<label class="col-sm-4 form-control-label">E-Posta *</label>
										         	<div class="col-sm-8">
										         		<input type="email" class="form-control form-control" name="yetkili_mail" data-validation="required emaill" id="yetkili_mail">
										         	</div>
										        </div>
