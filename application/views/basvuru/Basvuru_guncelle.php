...
<div class="col-lg-11 padding-header">
   <div class="card">
      <div class="card-body">
         ...
         <?php if($staj_durum == 2)
            {
            	echo'	<form class="form-horizontal" method="post" action="'.base_url().'stajbasvuru/basvuru_YenidenGonder_islemi/'.$id2.'/'.$row->id.'">';
            }
            else
            {
            	echo'	<form class="form-horizontal" method="post" action="'.base_url().'stajbasvuru/basvuru_Guncelle_islemi/'.$id2.'/'.$row->id.'">';
            }
            ?>
            ...
            <div class="form-group row">
               ...
               <div class="col-sm-8">
                  <input type="text" class="form-control a b" name="staj_suresi" id ="gun" required="required" value='<?=$row->staj_gun?>'>
               </div>
            </div>
            <br><br>
            <div class="row">
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                     <input type="email" class="form-control a" name="sirket_mail" required="required" id="sirket_mail" value='.$row->stajyeri_mail.'>
                  </div>
               </div>
               <div class="line"></div>
               <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                     <input type="text" class="form-control a" name="sirket_web" required="required" id="sirket_web" value='.$row->stajyeri_website.'>
                  </div>
               </div>
            </div>
            <!-- col-sm-6 -->
            <div class="col-sm-6">
               ...
               <div class="form-group row">
                  <label class="col-sm-4 form-control-label">E-Posta *</label>
                  <div class="col-sm-8">
                     <input type="email" class="form-control a" name="yetkili_mail" required="required" id="yetkili_mail" value='.$row->yetkili_mail.'>
                  </div>
               </div>
            </div>
            <!-- col-sm-6 -->';
      ...
      if(($staj_durum == 2 or $staj_durum == 0)  and ($row->durum == 0 || $row->durum == 2))
      {
		echo '<input id="stajDurum" type="hidden" value="2">';
		  ...
		  if ($row->durum == 2){
			  ...
			  echo'<input id="btn_Basvuruguncelle" type="submit" class="btn btn-info btn-sm"  style="visibility: hidden;" value="Başvuruyu Güncelle" name="btn_Basvuruguncelle">';
		  }
