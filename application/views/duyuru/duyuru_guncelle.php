...
//textboxlara yazdım
  ...
  $("input[name=duyuru_icerik]").val('<?= $duyuru_icerik ?>');
                    ...
                    <div class="card-body">
                      ...
                      <form action="<?= base_url();?>duyuru/duyuru_Guncelle_islemi/<?=@$id;?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control"		name="duyuru_icerik">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          <div class="col-sm-4 offset-sm-3">
                            <button type="submit" name="btn_guncelle" class="btn btn-primary">Kaydet</button>
                          </div>
                        </div>
