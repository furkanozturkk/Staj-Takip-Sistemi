...
if ($profil==0)
{
 ...
 <header class="page-header">
    ...
    <div class="col-lg-12" style="padding-top: 51px;">
                  <div class="card">
                  <div class="card-body">
    <form action="'.base_url().'Profil/profil_Ekle_islemi/" method="post" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="tc_no" required="required">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="baba_adi" required="required">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-4 form-control-label">Anne Adı</label>
            <div class="col-sm-8">
                <input type="text" class="form-control" name="ana_adi" required="required">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="il" required="required">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-4 form-control-label">İlçe</label>
            <div class="col-sm-8">
                <input type="text" class="form-control" name="ilce" required="required">
            </div>
        </div>
    </div>
    <div class="col-sm-6">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="cilt_no" required="required">
            </div>
        </div>
         <div class="form-group row">
            <label class="col-sm-4 form-control-label">Aile Sıra No</label>
            <div class="col-sm-8">
                <input type="text" class="form-control" name="ailesira_no" required="required">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-4 form-control-label">Sıra No</label>
            <div class="col-sm-8">
                <input type="text" class="form-control" name="sira_no" required="required">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-4 form-control-label">Verildiği Yer</label>
            <div class="col-sm-8">
                <input type="text" class="form-control" name="verildigi_yer" required="required">
            </div>
        </div>
         <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="verilis_nedeni" required="required">
            </div>
        </div>
    </div>
</div>
...
<table class="table table-sm table-size">
        <tbody>
		 ...
		 <form action="'.base_url().'Profil/profil_Guncelle_islemi/" method="post" class="form-horizontal" enctype="multipart/form-data">
        <div class="row col-sm-11" style="margin-left:auto;margin-right:auto;">
		<div class="col-sm-12">
		<button type="button" class="btn btn-info btn-sm pull-right"><i id="guncelle_button" class="fa fa-lock" aria-hidden="true" style="float:right;"> Düzenle</i></button>
        ...
        <div class="form-group row">
            <label class="col-sm-4 form-control-label">Tc Kimlik No</label>
            <div class="col-sm-8">
                <input type="text" class="form-control p" name="tc_no" required="required" value="'.$row->tc_no.'" style="color:#aaaaaa;" disabled="disabled" >
            </div>
        </div>
        <div class="form-group row">
