...
<div class="col-md-4"></div>
 <div class="col-md-4">
	...
	<span class="error_messagee"><?=  @$mailebakma?></span></div>
 </div>
<div class="col-md-4"></div>
</div>
  ...
  <button type="button" onclick="document.getElementById('id01').style.display='none'" class="cancelbtn pull-right" style="color:white;">X</button>
	<div class="col-sm-6" >
			<div class="col-sm-12" style="margin-top:40px;">
				...
				<input id="login-ogrno" type="text" name="ogr_no" data-validation="required">
			</div>
			<div class="col-sm-12">
		...
		<div class="col-sm-12" style="padding: 15px 30px;">
			<a name="" class="btn btn-primary pull-right giris_btn">Geri Dön </a>
			<a name="btn_kayit" class="pull-left kayit_btn"><button name="btn_kayit" id="btn_kayit"  class="btn btn-primary">Kayıt Ol</button> </a>
		</div>    	 
...
<div class="col-sm-12"><label><b>E-Mail</b></label></div>
	...
	<div class="col-sm-12" style="padding-top:3px;">		
		<a name="btn_unuttum" class="pull-left"><input type="submit" name="btn_unuttum" class="btn btn-primary" value="Şifre sıfırlama isteği gönder" /> </a>
	</div> 
...
<div class="col-md-4 signinak ">
  ...
  <button type="button" onclick="document.getElementById('id02').style.display='none'" style="color:white;" class="cancelbtn pull-right">X</button>
   ...
   <span class="col-sm-12 " id="file_error3"></span>
	 <div class="col-sm-12" style="padding-top:3px;">		
		<a name="btn_login" class="pull-left"><input type="submit" name="btn_login" class="btn btn-primary" onclick="girisKontrol2();" value="Giriş" /> </a>
