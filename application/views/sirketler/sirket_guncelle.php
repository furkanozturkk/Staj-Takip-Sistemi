...
<div class="col-lg-12" style="padding-top: 51px;">
                  ...
                  <div class="card-body">
                      ...
                      <form action="<?= base_url();?>Sirketler/sirket_Guncelle_islemi/<?=@$id;?>" method="post" class="form-horizontal" enctype="multipart/form-data">
						...
						<div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="email" class="form-control"   name="sirket_mail">
                          </div>
                        </div>
                        <div class="line"></div>
						...
						<div class="form-group row">
                          ...
                          <div class="col-sm-9">
                             <input type="email" class="form-control"   name="yetkili_mail">
                          </div>
