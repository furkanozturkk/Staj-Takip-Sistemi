...
class Denetmen_Model extends CI_Model{
	...
	public function islemleri_bitmis_ogrenci()
	{
		...
		tbl_akademisyen.akademisyen_no=tbl_ogrenciler.akademisyen_no  INNER JOIN tbl_stajyeri on 
		tbl_stajyeri.id = tbl_stajbilgileri.stajyeri_id where tbl_stajbilgileri.gun_girisi_yapildi=0");
		return $query->result();
	}
